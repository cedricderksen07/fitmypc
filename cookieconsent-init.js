...
function showSiteBlocker() {
    ...
    blocker.tabIndex = 0; // allow focus so we can trap tab key if needed

    // Prevent default tabbing while modal is visible
    blocker.addEventListener('keydown', function (e) {
        if (e.key === 'Tab') {
            e.preventDefault();
        }
    }, true);
